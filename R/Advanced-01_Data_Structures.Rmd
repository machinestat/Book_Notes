...
```
It will return "NULL". The dim() function retrieves or sets the dimension of an R object, for example a matrix, array or data frame. For an array (and hence in particular, for a matrix) dim retrieves the dim attribute of the object. It is NULL or a vector of mode integer.
```
